...
class FindRangeFn(beam.DoFn):
     def process(self, element, lower, upper):
...
(p 
   ...
   | "find word between range" >> beam.ParDo(FindRangeFn(),10,100)
   | "Write Output" >> beam.io.WriteToText('mybeam/sideinputs_pardo.txt')
)
